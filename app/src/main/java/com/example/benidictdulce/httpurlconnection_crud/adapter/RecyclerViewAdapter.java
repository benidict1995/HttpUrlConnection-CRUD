package com.example.benidictdulce.httpurlconnection_crud.adapter;
...
import com.example.benidictdulce.httpurlconnection_crud.R;
import com.example.benidictdulce.httpurlconnection_crud.View_User;
        ...
        public ViewHolder(final View itemView) {
            ...
            cardView.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(v.getContext(), View_User.class);
